...
func TestAdverb(t *testing.T) {
	tests := []struct {
		...
		// A-prefix words already functioning as adverbs
		{name: "ahead", input: "ahead", want: "ahead"},
		{name: "away", input: "away", want: "away"},
		{name: "alone", input: "alone", want: "alone"},
		{name: "aloud", input: "aloud", want: "aloud"},
		{name: "apart", input: "apart", want: "apart"},
		{name: "abroad", input: "abroad", want: "abroad"},
		{name: "afoot", input: "afoot", want: "afoot"},
		{name: "afloat", input: "afloat", want: "afloat"},
		{name: "ashore", input: "ashore", want: "ashore"},
		{name: "asleep", input: "asleep", want: "asleep"},
		{name: "awake", input: "awake", want: "awake"},
		{name: "alive", input: "alive", want: "alive"},
		{name: "askew", input: "askew", want: "askew"},
		{name: "awry", input: "awry", want: "awry"},

		// Adjectives ending in -ile: keep the e, add -ly
		{name: "agile", input: "agile", want: "agilely"},
		{name: "docile", input: "docile", want: "docilely"},
		{name: "fragile", input: "fragile", want: "fragilely"},
		{name: "fertile", input: "fertile", want: "fertilely"},
		{name: "hostile", input: "hostile", want: "hostilely"},
		{name: "mobile", input: "mobile", want: "mobilely"},
		{name: "servile", input: "servile", want: "servilely"},
		{name: "senile", input: "senile", want: "senilely"},
		{name: "sterile", input: "sterile", want: "sterilely"},
		{name: "versatile", input: "versatile", want: "versatilely"},
		{name: "juvenile", input: "juvenile", want: "juvenilely"},
		{name: "volatile", input: "volatile", want: "volatilely"},
		{name: "futile", input: "futile", want: "futilely"},
		{name: "ductile", input: "ductile", want: "ductilely"},
		{name: "tactile", input: "tactile", want: "tactilely"},
		{name: "virile", input: "virile", want: "virilely"},
		{name: "puerile", input: "puerile", want: "puerilely"},
