...
func ExampleInflect_adverb() {
	fmt.Println(inflect.Inflect("He ran adverb('quick')"))
	fmt.Println(inflect.Inflect("She spoke adverb('soft')"))
	fmt.Println(inflect.Inflect("The dog barked adverb('loud')"))
	// Output:
	// He ran quickly
	// She spoke softly
...
func ExampleInflect_capitalize() {
	fmt.Println(inflect.Inflect("Title: capitalize('hello')"))
	fmt.Println(inflect.Inflect("Name: capitalize('world')"))
	// Output:
	// Title: Hello
	// Name: World
}

func ExampleInflect_titleize() {
	fmt.Println(inflect.Inflect("Book: titleize('the great gatsby')"))
	fmt.Println(inflect.Inflect("Article: titleize('how to cook pasta')"))
	// Output:
	// Book: The Great Gatsby
	// Article: How To Cook Pasta
}

func ExampleInflect_wordOrdinals() {
	// word_to_ordinal converts number words to ordinal words
	fmt.Println(inflect.Inflect("The word_to_ordinal('one') place"))
	fmt.Println(inflect.Inflect("My word_to_ordinal('twenty') birthday"))
	// ordinal_to_cardinal converts ordinal words to cardinal words
	fmt.Println(inflect.Inflect("Item ordinal_to_cardinal('first')"))
	fmt.Println(inflect.Inflect("Number ordinal_to_cardinal('fifth')"))
	// Output:
	// The first place
...
func ExampleInflect_fraction() {
	fmt.Println(inflect.Inflect("I ate fraction(1, 4) of the pie"))
	fmt.Println(inflect.Inflect("We need fraction(3, 4) cup of flour"))
	fmt.Println(inflect.Inflect("Only fraction(1, 2) remains"))
	// Output:
	// I ate one quarter of the pie
	// We need three quarters cup of flour
	// Only one half remains
}

func ExampleInflect_formatNumber() {
	fmt.Println(inflect.Inflect("Revenue: $format_number(1000000)"))
	fmt.Println(inflect.Inflect("Population: format_number(7890123)"))
	fmt.Println(inflect.Inflect("Distance: format_number(42195) meters"))
	// Output:
	// Revenue: $1,000,000
	// Population: 7,890,123
	// Distance: 42,195 meters
}

func ExampleInflect_caseConversion() {
	// snake_case
	fmt.Println(inflect.Inflect("Variable: snake_case('HelloWorld')"))
	// camel_case
	fmt.Println(inflect.Inflect("Property: camel_case('hello_world')"))
	// pascal_case
	fmt.Println(inflect.Inflect("Class: pascal_case('my_class')"))
	// kebab_case
	fmt.Println(inflect.Inflect("URL: kebab_case('MyPage')"))
	// humanize
	fmt.Println(inflect.Inflect("Label: humanize('employee_salary')"))
	// Output:
...
func ExampleInflect_rails() {
	// tableize converts class names to table names
	fmt.Println(inflect.Inflect("Table: tableize('Person')"))
	// foreign_key converts class names to foreign key column names
	fmt.Println(inflect.Inflect("FK: foreign_key('User')"))
	// typeify converts table names back to type names
	fmt.Println(inflect.Inflect("Type: typeify('user_posts')"))
	// parameterize converts strings to URL-friendly slugs
	fmt.Println(inflect.Inflect("Slug: parameterize('Hello World!')"))
	// asciify converts Unicode to ASCII
	fmt.Println(inflect.Inflect("ASCII: asciify('café')"))
	// Output:
	// Table: people
	// FK: user_id
	// Type: UserPost
...
func ExampleInflect_numberFormats() {
	// number_to_words_with_and includes "and" in large numbers
	fmt.Println(inflect.Inflect("Amount: number_to_words_with_and(123)"))
	// number_to_words_threshold spells out small numbers, uses digits for large
	fmt.Println(inflect.Inflect("Count: number_to_words_threshold(5, 10)"))
	fmt.Println(inflect.Inflect("Count: number_to_words_threshold(15, 10)"))
	// currency_to_words converts money amounts to words
	fmt.Println(inflect.Inflect("Price: currency_to_words(1.50, 'USD')"))
	// Output:
	// Amount: one hundred and twenty-three
	// Count: five
	// Count: 15
	// Price: one dollar and fifty cents
}

func ExampleInflect_compare() {
	// compare checks if two words are singular/plural forms
	fmt.Println(inflect.Inflect("compare('cat', 'cat')"))  // equal
	fmt.Println(inflect.Inflect("compare('cat', 'cats')")) // singular:plural
	fmt.Println(inflect.Inflect("compare('cats', 'cat')")) // plural:singular
	// compare_nouns for nouns specifically
	fmt.Println(inflect.Inflect("compare_nouns('child', 'children')"))
	// compare_verbs for verbs
	fmt.Println(inflect.Inflect("compare_verbs('is', 'are')"))
	// compare_adjs for adjectives
	fmt.Println(inflect.Inflect("compare_adjs('this', 'these')"))
	// Output:
	// eq
	// s:p
	// p:s
...
func ExampleInflect_wordCount() {
	fmt.Println(inflect.Inflect("Words: word_count('hello world')"))
	fmt.Println(inflect.Inflect("Length: word_count('the quick brown fox')"))
	// Output:
	// Words: 2
	// Length: 4
}
